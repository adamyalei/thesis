...
public class MyOdDetector extends MyOdDetectorAlgorithm 				// Separating the algorithm implementation and the Metanome interface implementation is good practice
	...
	public void setIntegerConfigurationValue(String identifier, Integer... values) throws AlgorithmConfigurationException {
		if (MyOdDetector.Identifier.SOME_INTEGER_PARAMETER.name().equals(identifier))
	...
	public void setBooleanConfigurationValue(String identifier, Boolean... values) throws AlgorithmConfigurationException {
		if (MyOdDetector.Identifier.SOME_BOOLEAN_PARAMETER.name().equals(identifier))
	...
	public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values) throws AlgorithmConfigurationException {
		if (!MyOdDetector.Identifier.INPUT_GENERATOR.name().equals(identifier))
			this.handleUnknownConfiguration(identifier, values);
