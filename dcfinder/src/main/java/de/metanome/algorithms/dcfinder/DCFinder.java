...
public class DCFinder extends DCFinderAlgorithm implements DenialConstraintAlgorithm, RelationalInputParameterAlgorithm,
  ...
  public static final String APPROXIMATION_DEGREE = "APPROXIMATION_DEGREE"; // error threshold
  public static final String CHUNK_LENGTH = "CHUNK_LENGTH";
  public static final String BUFFER_LENGTH = "BUFFER_LENGTH";
  public static final String INPUT_GENERATOR = "INPUT_GENERATOR";
  ...
  public enum Identifier {
    INPUT_GENERATOR, CROSS_COLUMN_STRING_MIN_OVERLAP, APPROXIMATION_DEGREE, NO_CROSS_COLUMN, CHUNK_LENGTH, BUFFER_LENGTH
  };

  @Override
  public void execute() throws AlgorithmExecutionException {

    Input input = new Input(inputGenerator.generateNewCopy());
...
//    IEvidenceSet evidenceSet = super.getEvidenceSet(input, predicates);
  ...
  public ArrayList<ConfigurationRequirement<?>> getConfigurationRequirements() {
    ...
    requirements.add(new ConfigurationRequirementRelationalInput(INPUT_GENERATOR));
  ...
  public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values)
      throws AlgorithmConfigurationException {
    if (!identifier.equals(INPUT_GENERATOR))
  ...
  public String getAuthors() {
    return "Yalei Li. [Eduardo Pena, Eduardo Cunha Felix Naumann]";
  }

  @Override
  public String getDescription() {
    return "An (approximate/exact) DC discovery method with triplet results.";
  }
}
