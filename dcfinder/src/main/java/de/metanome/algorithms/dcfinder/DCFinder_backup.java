...
public class DCFinder extends
		DCFinderAlgorithm        // Separating the algorithm implementation and the Metanome interface implementation is good practice
	...
	public String getAuthors() {
		return "Yalei Li"; // A string listing the author(s) of this algorithm
	}

	@Override
	public String getDescription() {
		return "Implementation of DCFinder with triplet results"; // A string briefly describing what this algorithm does
	}
	...
	public ArrayList<ConfigurationRequirement<?>> getConfigurationRequirements() { // Tells Metanome which and how many parameters the algorithm needs
		...
		conf.add(new ConfigurationRequirementRelationalInput(DCFinder.Identifier.INPUT_GENERATOR.name()));
		...
		ConfigurationRequirementString stringParameter = new ConfigurationRequirementString(DCFinder.Identifier.SOME_STRING_PARAMETER.name());
		...
		ConfigurationRequirementInteger integerParameter = new ConfigurationRequirementInteger(DCFinder.Identifier.SOME_INTEGER_PARAMETER.name());
		...
		ConfigurationRequirementBoolean booleanParameter = new ConfigurationRequirementBoolean(DCFinder.Identifier.SOME_BOOLEAN_PARAMETER.name());
	...
	public void setStringConfigurationValue(String identifier, String... values) throws AlgorithmConfigurationException {
		if (DCFinder.Identifier.SOME_STRING_PARAMETER.name().equals(identifier))
	...
	public void setIntegerConfigurationValue(String identifier, Integer... values) throws AlgorithmConfigurationException {
		if (DCFinder.Identifier.SOME_INTEGER_PARAMETER.name().equals(identifier))
	...
	public void setBooleanConfigurationValue(String identifier, Boolean... values) throws AlgorithmConfigurationException {
		if (DCFinder.Identifier.SOME_BOOLEAN_PARAMETER.name().equals(identifier))
	...
	public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values) throws AlgorithmConfigurationException {
		if (!DCFinder.Identifier.INPUT_GENERATOR.name().equals(identifier))
			this.handleUnknownConfiguration(identifier, values);
